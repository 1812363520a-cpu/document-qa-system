...
This FastAPI backend uploads TXT, Markdown, PDF, and Word `.docx` documents, stores source files and metadata, parses documents into chunks, indexes chunks for local retrieval, answers document-grounded questions, tracks conversation history, and supports configurable AI providers.
